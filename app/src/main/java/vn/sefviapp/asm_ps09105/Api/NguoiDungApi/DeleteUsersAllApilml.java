...
public class DeleteUsersAllApilml extends BaseRetrofitIml {
    DeleteUsersAllApi deleteUsersAllApi;
    Retrofit retrofit = getRetrofit();

    public void DeleteUserAll(String id, final LoginListener loginListener){
        deleteUsersAllApi = retrofit.create(DeleteUsersAllApi.class);
        Call<ResponseBody> call = deleteUsersAllApi.DeleteUserAll(id);
