...
public class EditTheLoaiApilml extends BaseRetrofitIml {
    EditTheLoaiApi editTheLoaiApi;
    Retrofit retrofit = getRetrofit();

    public void EditTheLoai(String idUser, String id, String nameTheLoai, String moTa, final TheLoaiListener loaiListener){
        editTheLoaiApi = retrofit.create(EditTheLoaiApi.class);
        Call<ResponseBody> bodyCall = editTheLoaiApi.EditTheLoai(idUser, id, nameTheLoai, moTa);
